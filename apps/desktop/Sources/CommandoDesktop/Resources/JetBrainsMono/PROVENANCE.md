...
- Native asset: `JetBrainsMono[wght].ttf`, the unmodified normal-style variable font with a `wght` range of 100 through 800
- Google Fonts source: `https://github.com/google/fonts/blob/2e05c1cf00a6e4f40a4b931600a90881c26e15cd/ofl/jetbrainsmono/JetBrainsMono%5Bwght%5D.ttf`
...
- Native asset SHA-256: `48715a42ec242c21e9f02692891e147d022299a52e48d5e413e1a942193ffeda`
- `OFL.txt` SHA-256: `b2fe5e8987594e9ffd1d2ca52a2f5d73eb8335243893c5d6254b5ad69269591d`

The Fontsource 5.2.8 Latin 400 and 700 browser files and the vendored Google Fonts TTF all report internal font revision `144900` (JetBrains Mono 2.211). Verification used Fontsource's WOFF fallback files because the local Fontconfig build does not decode WOFF2:
